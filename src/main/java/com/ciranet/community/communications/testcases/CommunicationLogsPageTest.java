...
public class CommunicationLogsPageTest extends TestBase 
{
	...
	public void verifyActionsLinksInternalTask() 
	{
	...
	public void verifyActionsLinksProjectTask()
	{
	...
	@Test(priority = 6, description = "Verify Communication Logs view hyperlinks", groups = {Constants.FUNCTIONAL_TESTING }, alwaysRun=true)
	public void verifyViewhyperlinks() 
	{
		LoggerManager.info("Verifying Communication Logs view hyperlinks");
		TestBase.setExtentReportSettings("Communication Logs view hyperlinks", Constants.FUNCTIONAL_TESTING, "Verify view hyperlinks", "Verifying Communication Logs view hyperlinks");
		communicationLogs = new CommunicationLogsPage(driver);
		assertTrue(communicationLogs.verifyViewColumnHyperlinks(), "Communication Logs property Address hyperlinks are not seen");
	}
